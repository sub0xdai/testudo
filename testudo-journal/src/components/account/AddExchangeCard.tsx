export function AddExchangeCard(props: { onClick: () => void }) {
  return (
    <button
      ...
      class="border border-dashed border-text-tertiary/50 glass-panel p-6 flex flex-col items-center justify-center gap-3 min-h-[160px] hover:border-text-secondary transition-colors group"
    >
