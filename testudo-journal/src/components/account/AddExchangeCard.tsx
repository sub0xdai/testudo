export function AddExchangeCard(props: { onClick: () => void }) {
  return (
    <button
      ...
      class="border border-dashed border-text-tertiary/50 bg-container-bg p-8 flex flex-col items-center justify-center gap-3 min-h-[200px] hover:border-text-secondary transition-colors group"
    >
