...
function ChromeIcon() {
  return (
    <svg viewBox="0 0 256 256" class="w-6 h-6" fill="currentColor">
      <path d="M128 0C57.308 0 0 57.308 0 128s57.308 128 128 128 128-57.308 128-128S198.692 0 128 0zm0 178.56c-27.917 0-50.56-22.643-50.56-50.56S100.083 77.44 128 77.44s50.56 22.643 50.56 50.56-22.643 50.56-50.56 50.56z"/>
      <path d="M128 77.44c-1.386 0-2.758.058-4.118.168L75.6 0h104.8L132.118 77.608c-1.36-.11-2.732-.168-4.118-.168z" opacity=".6"/>
      <path d="M77.608 123.882C77.468 125.242 77.44 126.614 77.44 128c0 27.917 22.643 50.56 50.56 50.56 1.386 0 2.758-.058 4.118-.168L180.4 256H24L77.608 123.882z" opacity=".4"/>
      <path d="M178.392 132.118c.14-1.36.168-2.732.168-4.118 0-27.917-22.643-50.56-50.56-50.56-1.386 0-2.758.058-4.118.168L75.6 0 232 0l-53.608 132.118z" opacity=".2"/>
    </svg>
  )
}
...
function FirefoxIcon() {
  return (
    <svg viewBox="0 0 77.42 79.97" class="w-6 h-6" fill="currentColor">
      <path d="M74.92 21.03a37.05 37.05 0 00-8.18-11.47c.72 2.24 1.2 4.55 1.25 5.39a31.72 31.72 0 00-12.8-16.2c-.22-.14-.44-.29-.65-.42a4.26 4.26 0 01-.21-.4.04.04 0 00-.07.01c-6.89 4.05-9.22 11.53-9.44 15.29a13.91 13.91 0 00-7.65 2.99c-.04-.03-.07-.06-.12-.1a12.08 12.08 0 01-.16-6.38c-2.51 1.13-4.48 3.01-5.92 4.64a9.06 9.06 0 00-2-.06c-1.26.06-2.5.32-3.67.77a16.67 16.67 0 01-.72-6.35A25.7 25.7 0 0018.03 16c-.55-.18-1.2-.33-1.3-.36A15.63 15.63 0 0018.6 10c-2.59 1.01-5.56 3.31-7.52 5.48.38-1.67 1-3.25 1.8-4.93A28.37 28.37 0 004.49 22.6l-.07.26c-.1.4-.2.81-.28 1.22v.06A38.6 38.6 0 003 29.86v.23A38.7 38.7 0 1074.92 21.03z"/>
    </svg>
  )
}
