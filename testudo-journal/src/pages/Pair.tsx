...
function ChromeIcon() {
  return (
    <svg viewBox="0 0 24 24" class="w-6 h-6" fill="currentColor">
      <path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm0 18c-4.42 0-8-3.58-8-8 0-1.85.63-3.55 1.69-4.9L9.5 14.5c.72 1.24 2.04 2 3.5 2 .47 0 .92-.08 1.35-.24l3.84 6.65C16.82 23.6 14.49 20 12 20zm8-8c0 1.85-.63 3.55-1.69 4.9L14.5 9.5c-.72-1.24-2.04-2-3.5-2-.47 0-.92.08-1.35.24L5.81 1.09C7.18.4 9.51 4 12 4c4.42 0 8 3.58 8 8zm-8-3a3 3 0 100 6 3 3 0 000-6z"/>
    </svg>
  )
}
...
function FirefoxIcon() {
  return (
    <svg viewBox="0 0 24 24" class="w-6 h-6" fill="currentColor">
      <path d="M20.452 7.2c-.35-.836-.957-1.753-1.425-2.14.476 1.082.588 2.008.6 2.422-.72-1.66-1.94-2.333-2.96-3.747-.052-.072-.103-.147-.152-.222a2.16 2.16 0 01-.05-.093 1.3 1.3 0 01-.072-.182.02.02 0 00-.017-.012.019.019 0 00-.012.003c-.003.002-.003.003-.005.005v.002c-1.595.937-2.136 2.67-2.186 3.54a3.22 3.22 0 00-1.772.693.18.18 0 00-.028-.024 2.8 2.8 0 01-.037-1.478c-.582.263-1.037.697-1.37 1.074a2.1 2.1 0 00-.463-.014c-.29.014-.578.074-.85.178a3.86 3.86 0 01-.167-1.472 5.95 5.95 0 00-1.538 1.677 4.4 4.4 0 00-.3-.084C7.202 6.927 7.598 5.842 7.82 5.42c-.6.234-1.286.766-1.74 1.268.088-.387.23-.753.417-1.14C5.774 6.1 4.85 7.356 4.52 8.575l-.015.06c-.024.093-.046.188-.064.283v.013A8.94 8.94 0 004 12a8 8 0 1016.452-5.2v.4z"/>
    </svg>
  )
}
