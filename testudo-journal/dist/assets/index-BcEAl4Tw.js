...
`;var E=function(t,e,i,r){var s=arguments.length,n=s<3?e:r===null?r=Object.getOwnPropertyDescriptor(e,i):r,o;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")n=Reflect.decorate(t,e,i,r);else for(var c=t.length-1;c>=0;c--)(o=t[c])&&(n=(s<3?o(n):s>3?o(e,i,n):o(e,i))||n);return s>3&&n&&Object.defineProperty(e,i,n),n};let L=class extends at{constructor(){super(...arguments),this.type="approve",this.onlyDirectionIcon=!1,this.images=[]}render(){return w`
      <wui-flex>
        <wui-transaction-visual
          .status=${this.status}
    ...
    `}templateDescription(){const e=this.descriptions?.[0];return e?w`
        ...
        `:null}};L.styles=[Tt,Vt];E([D()],L.prototype,"type",void 0);E([D({type:Array})],L.prototype,"descriptions",void 0);E([D()],L.prototype,"date",void 0);E([D({type:Boolean})],L.prototype,"onlyDirectionIcon",void 0);E([D()],L.prototype,"status",void 0);E([D()],L.prototype,"direction",void 0);E([D({type:Array})],L.prototype,"images",void 0);L=E([ot("wui-transaction-list-item")],L);const Jt=st`
  wui-flex {
    position: relative;
    display: inline-flex;
    justify-content: center;
...
`;var ut=function(t,e,i,r){var s=arguments.length,n=s<3?e:r===null?r=Object.getOwnPropertyDescriptor(e,i):r,o;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")n=Reflect.decorate(t,e,i,r);else for(var c=t.length-1;c>=0;c--)(o=t[c])&&(n=(s<3?o(n):s>3?o(e,i,n):o(e,i))||n);return s>3&&n&&Object.defineProperty(e,i,n),n};const wt={sm:"xxs",lg:"md"};let H=class extends at{constructor(){super(...arguments),this.type="approve",this.size="lg",this.statusImageUrl="",this.images=[]}render(){return w`<wui-flex>${this.templateVisual()} ${this.templateIcon()}</wui-flex>`}templateVisual(){switch(this.dataset.size=this.size,this.type){case"trade":return this.swapTemplate();case"fiat":return this.fiatTemplate();case"unknown":return this.unknownTemplate();default:return this.tokenTemplate()}}swapTemplate(){const[e,i]=this.images;return this.images.length===2&&(e||i)?w`
    ...
    ></wui-icon>`}getTemplateIcon(){return this.type==="trade"?"arrowClockWise":"arrowBottom"}};H.styles=[Jt];ut([D()],H.prototype,"type",void 0);ut([D()],H.prototype,"size",void 0);ut([D()],H.prototype,"statusImageUrl",void 0);ut([D({type:Array})],H.prototype,"images",void 0);H=ut([ot("wui-transaction-thumbnail")],H);const Zt=st`
  :host > wui-flex:first-child {
    gap: ${({spacing:t})=>t[2]};
