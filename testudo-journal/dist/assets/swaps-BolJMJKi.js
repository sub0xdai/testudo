import{x as P,D as I,C as v,N as h,F as c,n as z,E as R,R as $,f as M,Z as K,L as F,W as Q,y as O,z as q}from"./index-Oorp8q_u.js";import{r as l,n as w,c as A}from"./index-CJEtPKbZ.js";import"./index-CCC_V81w.js";import"./index-COyT3e0k.js";import"./index-BYqXOkGG.js";import{S as r}from"./SwapController-CKIz5ojX.js";import"./index-CcdelanG.js";import"./index-BAHWlHye.js";import{M as L}from"./MathUtil-BGCe3rZ3.js";import"./index-Db94Knkq.js";import"./index-BJBPKqJD.js";import"./index-B_In4kDJ.js";import"./if-defined-BEq0J4ts.js";import"./ref-PaSoAqr5.js";const H={numericInputKeyDown(e,t,o){const n=["Backspace","Meta","Ctrl","a","A","c","C","x","X","v","V","ArrowLeft","ArrowRight","Tab"],s=e.metaKey||e.ctrlKey,i=e.key,a=i.toLocaleLowerCase(),u=a==="a",C=a==="c",W=a==="v",V=a==="x",E=i===",",_=i===".",N=i>="0"&&i<="9";!s&&(u||C||W||V)&&e.preventDefault(),t==="0"&&!E&&!_&&i==="0"&&e.preventDefault(),t==="0"&&N&&(o(i),e.preventDefault()),(E||_)&&(t||(o("0."),e.preventDefault()),(t?.includes(".")||t?.includes(","))&&e.preventDefault()),!N&&!n.includes(i)&&!_&&!E&&e.preventDefault()}},G=P`
  :host {
    width: 100%;
  }
...
`;var T=function(e,t,o,n){var s=arguments.length,i=s<3?t:n===null?n=Object.getOwnPropertyDescriptor(t,o):n,a;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")i=Reflect.decorate(e,t,o,n);else for(var u=e.length-1;u>=0;u--)(a=e[u])&&(i=(s<3?a(i):s>3?a(t,o,i):a(t,o))||i);return s>3&&i&&Object.defineProperty(t,o,i),i};const J=5e-5;let k=class extends I{constructor(){super(...arguments),this.focused=!1,this.price=0,this.target="sourceToken",this.onSetAmount=null,this.onSetMaxValue=null}render(){const t=this.marketValue||"0",o=h.bigNumber(t).gt("0");return c`
    ...
    </button>`}onFocusChange(t){this.focused=t}onSelectToken(){R.sendEvent({type:"track",event:"CLICK_SELECT_TOKEN_TO_SWAP"}),$.push("SwapSelectToken",{target:this.target})}onBuyToken(){$.push("OnRampProviders")}};k.styles=[X];T([w()],k.prototype,"focused",void 0);T([w()],k.prototype,"balance",void 0);T([w()],k.prototype,"value",void 0);T([w()],k.prototype,"price",void 0);T([w()],k.prototype,"marketValue",void 0);T([w()],k.prototype,"disabled",void 0);T([w()],k.prototype,"target",void 0);T([w()],k.prototype,"token",void 0);T([w()],k.prototype,"onSetAmount",void 0);T([w()],k.prototype,"onSetMaxValue",void 0);k=T([A("w3m-swap-input")],k);const ee=P`
