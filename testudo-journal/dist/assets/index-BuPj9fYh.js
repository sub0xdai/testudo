import{I as b,s as v,v as y,w as x,H as $,D as g,R,Z as T,F as m,x as C}from"./index-CgjC7Uwr.js";import{n as P,r as h,c as w}from"./index-BQnduQSC.js";const a=x({message:"",open:!1,triggerRect:{width:0,height:0,top:0,left:0},variant:"shade"}),_={state:a,subscribe(t){return y(a,()=>t(a))},subscribeKey(t,e){return v(a,t,e)},showTooltip({message:t,triggerRect:e,variant:o}){a.open=!0,a.message=t,a.triggerRect=e,a.variant=o},hide(){a.open=!1,a.message="",a.triggerRect={width:0,height:0,top:0,left:0}}},s=b(_),j=$`
  :host {
    width: 100%;
    display: block;
  }
