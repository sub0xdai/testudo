import{c as x,a as b,i as v,j as D,f as g,s as j,L as l,b as c,R as h,N as F,U as N,M as q,Y as K,S as y,y as Q,a0 as X,g as Y,r as J,e as G,a1 as z,a2 as L,E as Z}from"./vendor-wallet-haM69aOm.js";import{n as d,r as u}from"./index-BZTiCSAG.js";import"./index--eqKgbZB.js";import"./index-DFSXAXiM.js";import"./index-DV-mhosP.js";import{e as H,n as M}from"./ref-CYHGUBtl.js";import"./index-BzUOdG5x.js";import"./index-BiYpcQmL.js";import"./index-x0Q3tfOA.js";import"./index-DUnKFQRP.js";import"./index-DIDdCwfM.js";import"./index-416g1Doe.js";import"./index-lCou6eTw.js";import{o as ee}from"./if-defined-rBAzWdFM.js";import"./index-BckTASaq.js";import"./index-D5vo664K.js";const te=x`
  :host {
    width: 100%;
    height: 100px;
...
`;var E=function(e,t,n,r){var o=arguments.length,i=o<3?t:r===null?r=Object.getOwnPropertyDescriptor(t,n):r,s;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")i=Reflect.decorate(e,t,n,r);else for(var a=e.length-1;a>=0;a--)(s=e[a])&&(i=(o<3?s(i):o>3?s(t,n,i):s(t,n))||i);return o>3&&i&&Object.defineProperty(t,n,i),i};let $=class extends v{constructor(){super(...arguments),this.inputElementRef=H(),this.instructionElementRef=H(),this.readOnly=!1,this.instructionHidden=!!this.value,this.pasting=!1,this.onDebouncedSearch=D.debounce(async t=>{if(!t.length){this.setReceiverAddress("");return}const n=g.state.activeChain;if(D.isAddress(t,n)){this.setReceiverAddress(t);return}try{const o=await j.getEnsAddress(t);if(o){l.setReceiverProfileName(t),l.setReceiverAddress(o);const i=await j.getEnsAvatar(t);l.setReceiverProfileImageUrl(i||void 0)}}catch{this.setReceiverAddress(t)}finally{l.setLoading(!1)}})}firstUpdated(){this.value&&(this.instructionHidden=!0),this.checkHidden()}render(){return this.readOnly?c` <wui-flex
...
`;var _=function(e,t,n,r){var o=arguments.length,i=o<3?t:r===null?r=Object.getOwnPropertyDescriptor(t,n):r,s;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")i=Reflect.decorate(e,t,n,r);else for(var a=e.length-1;a>=0;a--)(s=e[a])&&(i=(o<3?s(i):o>3?s(t,n,i):s(t,n))||i);return o>3&&i&&Object.defineProperty(t,n,i),i};let T=class extends v{constructor(){super(...arguments),this.text=""}render(){return c`<wui-text variant="lg-regular" color="primary">${this.text}</wui-text>
      ${this.imageTemplate()}`}imageTemplate(){return this.address?c`<wui-avatar address=${this.address} .imageSrc=${this.imageSrc}></wui-avatar>`:this.imageSrc?c`<wui-image src=${this.imageSrc}></wui-image>`:c`<wui-icon size="lg" color="inverse" name="networkPlaceholder"></wui-icon>`}};T.styles=[J,G,oe];_([d({type:String})],T.prototype,"text",void 0);_([d({type:String})],T.prototype,"address",void 0);_([d({type:String})],T.prototype,"imageSrc",void 0);T=_([b("wui-preview-item")],T);const se=x`
  :host {
    display: flex;
