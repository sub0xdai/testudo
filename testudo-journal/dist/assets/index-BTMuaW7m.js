import{c as b,a as v,i as $,b as o,r as _,f as k,G as u,j as C,H as O,R as T,O as P,E as U,h as L,W as N,I as F}from"./vendor-wallet-wGs4YUhB.js";import{n as c,r as y}from"./index-CvRbhMtw.js";import"./index-Ds-r0b0_.js";import"./index-BwGhKu-j.js";import{o as B}from"./if-defined-CDxDRglf.js";import"./index-fnDPpfmp.js";import"./index-B9eYHaCj.js";var D;(function(e){e.approve="approved",e.bought="bought",e.borrow="borrowed",e.burn="burnt",e.cancel="canceled",e.claim="claimed",e.deploy="deployed",e.deposit="deposited",e.execute="executed",e.mint="minted",e.receive="received",e.repay="repaid",e.send="sent",e.sell="sold",e.stake="staked",e.trade="swapped",e.unstake="unstaked",e.withdraw="withdrawn"})(D||(D={}));const E=b`
  :host > wui-flex {
    display: flex;
