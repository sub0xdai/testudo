import{y as O,F as b,ak as c,al as C,O as T,G as u,_ as $,C as I,V as E,R as D,h as B,E as V,M as z,W as N,K,X as M,j as W}from"./index-DMk_xwMX.js";import{r as l,c as g,n as p}from"./index-DF2PRLaW.js";import{o as m}from"./if-defined-DvlR3LEP.js";import"./index-DuaLUQVP.js";import{O as j}from"./index-DSBlTvZP.js";import"./index-CNo0tqtZ.js";import"./index-D4N6W987.js";import"./index-DR5YZCgx.js";import"./index-BbGlnUZe.js";import"./index-B2NuVweL.js";import"./index-CGDq_l0r.js";import"./index-Dr04Wpuv.js";import"./index-ClTG6Y6_.js";import"./ref-BlqpazNN.js";const q=O`
  :host > wui-grid {
    max-height: 360px;
    overflow: auto;
  }
...
`;var y=function(t,e,r,o){var s=arguments.length,i=s<3?e:o===null?o=Object.getOwnPropertyDescriptor(e,r):o,n;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")i=Reflect.decorate(t,e,r,o);else for(var a=t.length-1;a>=0;a--)(n=t[a])&&(i=(s<3?n(i):s>3?n(e,r,i):n(e,r))||i);return s>3&&i&&Object.defineProperty(e,r,i),i};let d=class extends b{constructor(){super(),this.unsubscribe=[],this.selectedOnRampProvider=c.state.selectedProvider,this.uri=K.state.wcUri,this.ready=!1,this.showRetry=!1,this.buffering=!1,this.error=!1,this.isMobile=!1,this.onRetry=void 0,this.unsubscribe.push(c.subscribeKey("selectedProvider",e=>{this.selectedOnRampProvider=e}))}disconnectedCallback(){this.intervalId&&clearInterval(this.intervalId)}render(){let e="Continue in external window";this.error?e="Buy failed":this.selectedOnRampProvider&&(e=`Buy in ${this.selectedOnRampProvider?.label}`);const r=this.error?"Buy can be declined from your side or due to and error on the provider app":"We’ll notify you once your Buy is processed";return u`
      <wui-flex
    ...
    `}};L=Q([g("w3m-what-is-a-buy-view")],L);const G=O`
  :host {
    width: 100%;
  }
