...
| T2 | Create AddExchangeCard + ExtensionPairingBanner — dashed ghost card with "+" icon and hover effect; compact full-width banner layout for extension pairing (title+button inline, condensed padding). | pending | low | — |
