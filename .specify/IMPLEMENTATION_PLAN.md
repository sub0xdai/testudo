...
### T2: Coach module scaffolding + types — `pending`
...
### T3a: Pattern detector — `sizing_drift` — `pending`
...
### T3b: Pattern detector — `frequency_spike` — `pending`
...
### T3c: Pattern detector — `session_anomaly` — `pending`
...
### T3d: Pattern detector — `setup_fatigue` — `pending`
...
### T3e: Pattern detector — `correlation_stack` — `pending`
...
Next task: T2 — Coach module scaffolding + types
